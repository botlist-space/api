...
class Server {
	 ...
	 * @property {Collection<string, User>} owners A collection of User classes who own the server.
	 * @memberof Server
	 */
	constructor(server) {
		this.id = server.id;
	 ...
	 * @returns {Collection<string, User>} A collection of User classes who own the server.
	 * @memberof Server
	 */
	getOwners() {
		return this.owners;
